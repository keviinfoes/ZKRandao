#Concept implementation ZKRandao node
...
def handle_event(block_filter):
    if block_filter != None:
        ...
        with cd("/Users/kevinfoesenek/Desktop/TEST_ZKrandao0.1/ZKRandao_submit"):
            ...
            #Create raw transaction for infura
            ...
            web3_ZKRandao.eth.sendRawTransaction(signed_txnDeposit.rawTransaction)
            print("Transaction succes")
            
#WRITE REVEAL FUNCTION            
            #ADD BASED ON SUBMIT FUNCTION
...
def main():
    ...
    while True:
        ...
        if TEMPindexBlockNumber > indexBlockNumber:
            indexBlockNumber += 1
            #if indexBlockNumber % 20 == 0: #Start submit proces every 20 blocks
